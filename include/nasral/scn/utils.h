...
namespace nasral::snc
{
    /**
     * @brief Вычислить вектор движения с учетом поворота
     * @param movement Направление движения на плоскости (игнорируем ось Y)
     * @param orientation Ориентация движения (в градусах, вращение по Y - лево/право и X - вверх/вниз)
