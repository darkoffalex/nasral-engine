...
namespace nasral::gfx
{
    ...
    public:
        ...
        void cmd_begin_screen_fx_mid_pass();
        ...
        [[nodiscard]] const auto& vk_intermediate_pass() const noexcept{ return *vk_screen_fx_mid_pass_; }
        ...
        [[nodiscard]] const auto& vk_intermediate_framebuffer(const size_t index) const noexcept{ return *vk_intermediate_framebuffers_[index]; }
    ...
    private:
        ...
        vk::UniqueRenderPass vk_screen_fx_mid_pass_;
        ...
        std::vector<vk::utils::Framebuffer::Ptr> vk_intermediate_framebuffers_;  //< Буферы промежуточного прохода (размытие и прочее)
